package com.woowle.eggwithtomato.common.util;
...
public class HttpClientUtil {
  ...
  private static RequestConfig requestConfig = RequestConfig.custom().setConnectTimeout(15000)
      .setConnectionRequestTimeout(7500).setSocketTimeout(15000).build();
  ...
  public static CloseableHttpClient getHttpsClient() throws Exception {
    ...
    try {
      ...
      e.printStackTrace();
      log.error("创建https连接出错。" + e.getMessage());
    }
    return httpClient;
  }
   ...
   * @author dubl
   */
  public static String sendHttpRequest(String url, httpRequestMethod method,
      Map<String, String> params) throws Exception {
    CloseableHttpResponse response = null;
    String result = null;
    log.info(method.name() + ":" + url + "--" + params);
   ...
   * @author dubl
   */
  public static String sendHttpRequestFile(String url, Map<String, String> params, File[] files)
      throws Exception {
    CloseableHttpClient httpClient = null;
    CloseableHttpResponse response = null;
    String result = null;
    try {
      ...
      for (Map.Entry<String, String> entry : params.entrySet()) {
        StringBody value = new StringBody(entry.getValue(), ContentType
   ...
   * 发送get请求
   */
  private static CloseableHttpResponse sendGetRequest(String url, Map<String, String> params)
      throws Exception {
   ...
   * 发送post请求
   */
  private static CloseableHttpResponse sendPostRequest(String url, Map<String, String> params)
      throws Exception {
    HttpPost httpPost = new HttpPost(url);
    httpPost.setConfig(requestConfig);
    if (params != null && params.size() > 0) {
