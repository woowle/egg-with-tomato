...
import com.woowle.eggwithtomato.common.VO.ResultCode;
import com.woowle.eggwithtomato.common.annotation.AffinityRetry;
...
public class AffinityRetryAspect {
  ...
  @Around(value = "@within(com.woowle.eggwithtomato.common.annotation.AffinityRetry) || @annotation(com.woowle.eggwithtomato.common.annotation.AffinityRetry)")
